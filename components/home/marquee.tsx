    ...
    <section className="relative w-full flex flex-col gap-8 py-12">
      <div className="flex flex-col gap-2">
        <BlurFade delay={0.1} inView>
          <h2>Co říkají na VR naši zákazníci</h2>
        </BlurFade>
        <BlurFade delay={0.2} inView>
          <p>
            Naši zákazníci o VR mluví s nadšením — a my jsme rádi, že jim můžeme
            přinášet nové zážitky a spoustu zábavy. Podívejte se, jak své chvíle
            ve virtuálním světě hodnotí.
          </p>
        </BlurFade>
      </div>
      <BlurFade
