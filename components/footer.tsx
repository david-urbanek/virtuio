          ...
          <div className="relative mb-8 flex w-full flex-col gap-x-28 gap-y-8 md:flex-row md:justify-between md:gap-y-0">
            <div className="max-w-96">
              ...
              <p className="text-muted-foreground text-base font-medium">
                Virtualní realita k Vám domů. Zažijte nový rozměr zábavy s
                našimi VR headsety.
              </p>
            </div>
            <div>
              ...
              <div className="flex gap-6 flex-col">
                <div className="flex gap-2 items-center">
                  ...
                  <a
                    href="mailto:info@virtuio.cz?subject=Rezervace%20VR%20headsetu&body=Dobrý%20den,"
                ...
                <div className="flex gap-2 items-center">
                  <Smartphone width={20} height={20}></Smartphone>
                  <a
                    href="tel:+420606980435"
                    className="text-foreground font-medium hover:underline"
                  >
                    +420 606 980 435
                  </a>
                ...
                <p>
                  IČ:{" "}
                  <span className="text-foreground font-medium">23375281</span>
                </p>
              </div>
            </div>
          </div>
