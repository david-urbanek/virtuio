                    ...
                    <FieldGroup>
                        ...
                        <Field>
                            ...
                            <Input
                                ...
                                onChange={handleChange}
                            />
                            {state.errors?.numberOfDays && <FieldError>{state.errors.numberOfDays}</FieldError>}
                        </Field>
                        ...
                        <Field>
                            ...
                            <p>
                                <span className='font-semibold'>Termín:</span> Od <span
                                    className='font-bold text-black'>{new Date(formData.date).toLocaleDateString('cs-CZ')}</span> do <span
